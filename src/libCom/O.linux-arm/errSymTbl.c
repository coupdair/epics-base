 ...
 *       FROM /media/data/home/rp/code/EPICS/base-3.16.1/src/libCom/O.linux-arm
 *         ON Thu Dec  3 08:45:22 2020
 */
...
static ERRSYMBOL symbols[] =
{
	...
	{ "No time provider", (long) S_time_noProvider },
	{ "Bad event number", (long) S_time_badEvent },
	{ "Invalid arguments", (long) S_time_badArgs },
	{ "Out of memory", (long) S_time_noMemory },
	{ "Provider not synchronized", (long) S_time_unsynchronized },
	{ "Invalid timeone", (long) S_time_timezone },
	{ "Time conversion error", (long) S_time_conversion },
