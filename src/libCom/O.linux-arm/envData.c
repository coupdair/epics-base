 ...
 *
 * Created from
 *   /media/data/home/rp/code/EPICS/base-3.16.1/src/libCom/env/envDefs.h
 *   /media/data/home/rp/code/EPICS/base-3.16.1/configure/CONFIG_ENV
 *   /media/data/home/rp/code/EPICS/base-3.16.1/configure/CONFIG_SITE_ENV
 */
...
epicsShareDef const ENV_PARAM EPICS_BUILD_TARGET_ARCH =
    {"EPICS_BUILD_TARGET_ARCH", "linux-arm"};
...
epicsShareDef const ENV_PARAM* env_param_list[] = {
    ...
    &IOCSH_PS1, &IOCSH_HISTSIZE, &IOCSH_HISTEDIT_DISABLE, NULL
};
